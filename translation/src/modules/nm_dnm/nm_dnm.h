...
namespace nmprk {
 ...
 namespace translation {
  ...
  namespace nm_dnm {
   ...
   bool                                nm_dnm_swSubSystemSetup(nmprk::translation::initType_t, nmprk::ipmi::device*);   // [un]Initilize software subsystems for a device 
   ...
   nmprk::translation::sample_t*       nm_dnm_getSample(nmprk::ipmi::device*,nmprk::translation::sampleType_t, nmprk::translation::subSystemComponentType_t, nmprk::translation::policy_t*); 
