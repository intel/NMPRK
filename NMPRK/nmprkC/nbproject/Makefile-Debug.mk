...
${OBJECTDIR}/RmcppTypes.o: RmcppTypes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RmcppTypes.o RmcppTypes.cpp

${OBJECTDIR}/LastError.o: LastError.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/LastError.o LastError.cpp

${OBJECTDIR}/CryptoProxyLinux.o: CryptoProxyLinux.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CryptoProxyLinux.o CryptoProxyLinux.cpp

${OBJECTDIR}/IpmiProxy.o: IpmiProxy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/IpmiProxy.o IpmiProxy.cpp

${OBJECTDIR}/RmcppIpmiProxy.o: RmcppIpmiProxy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RmcppIpmiProxy.o RmcppIpmiProxy.cpp

${OBJECTDIR}/nmprkUtilities.o: nmprkUtilities.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/nmprkUtilities.o nmprkUtilities.cpp

${OBJECTDIR}/ByteVector.o: ByteVector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ByteVector.o ByteVector.cpp

${OBJECTDIR}/RmcppIpmiError.o: RmcppIpmiError.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RmcppIpmiError.o RmcppIpmiError.cpp

${OBJECTDIR}/RmcppIpmiPayload.o: RmcppIpmiPayload.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RmcppIpmiPayload.o RmcppIpmiPayload.cpp

${OBJECTDIR}/OpenIpmiProxy.o: OpenIpmiProxy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/OpenIpmiProxy.o OpenIpmiProxy.cpp

${OBJECTDIR}/transportInterfaceSlim.o: transportInterfaceSlim.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/transportInterfaceSlim.o transportInterfaceSlim.cpp

${OBJECTDIR}/transportInterfaceOriginal.o: transportInterfaceOriginal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/transportInterfaceOriginal.o transportInterfaceOriginal.cpp

${OBJECTDIR}/RmcppIpmiSession.o: RmcppIpmiSession.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RmcppIpmiSession.o RmcppIpmiSession.cpp

${OBJECTDIR}/RmcppIpmiHeader.o: RmcppIpmiHeader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RmcppIpmiHeader.o RmcppIpmiHeader.cpp

${OBJECTDIR}/transportInterface.o: transportInterface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/transportInterface.o transportInterface.cpp

${OBJECTDIR}/RmcppIpmiRequest.o: RmcppIpmiRequest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RmcppIpmiRequest.o RmcppIpmiRequest.cpp

${OBJECTDIR}/RmcppIpmiResponse.o: RmcppIpmiResponse.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RmcppIpmiResponse.o RmcppIpmiResponse.cpp

${OBJECTDIR}/nmprkC.o: nmprkC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/nmprkC.o nmprkC.cpp
