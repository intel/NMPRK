...
public:
     ...
     */
    void sendRecv(const ipmi_req_t& req, ipmi_rsp_t& rsp, bool inSession = true);

	void sendRecv(timeval timeoutVal, bool bSend, 
					 bool bRecv, bool& timeout, 
					 const ipmi_req_t& req, ipmi_rsp_t& rsp, bool inSession = true);
...
private:
     ...
     *      non-session message.
     */
    virtual void serializeRequest(ByteVector& out, const ipmi_req_t& req, bool inSession) = 0;
     ...
     */
    virtual void deserializeResponse(ipmi_rsp_t& rsp, const ByteVector& in) = 0;
};
...
private:
     ...
     *      non-session message.
     */
    virtual void serializeRequest(ByteVector& out, const ipmi_req_t& req, bool inSession);
     ...
     * @param in Input buffer that contains response raw data response.
     */
    virtual void deserializeResponse(ipmi_rsp_t& rsp, const ByteVector& in);
     ...
     * @param req Request to serialize.
     */
    void serializeIntRequest(ByteVector& out, ipmi_payload payloadType, const ipmi_req_t& req);
     ...
     */
    void sendRecvInt(ipmi_payload reqPayloadType, const ipmi_req_t& req, 
